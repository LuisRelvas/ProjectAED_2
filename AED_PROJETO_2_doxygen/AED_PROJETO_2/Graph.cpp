...
vector<int> Graph::bfs_airlines(int origem, int destino, const set<string>& companhias) {
    ...
    while(!q.empty()){
        ...
        for(const Edge& e : nodes[v].adj){
            ...
            set_intersection(companhias.begin(), companhias.end(), e.airlines.begin(), e.airlines.end(), inserter(inter_comp, inter_comp.begin()));
